...
**Languages**: en_US and pt_BR (ALWAYS create the locales variables)
...
## Catraca
- Always run `catraca` quality gate before committing changes and fix any issue: `./vendor/bin/catraca` 
